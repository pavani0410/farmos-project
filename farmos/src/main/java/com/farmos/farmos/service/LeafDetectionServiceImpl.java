...
@Service
public class LeafDetectionServiceImpl implements LeafDetectionService {
    ...
    public void loadDiseaseDetails() {
        try {
            ...
            try (InputStream stream = resource.getInputStream()) {
                ...
                List<Map<String, Object>> diseases = mapper.readValue(stream, new TypeReference<>() {});
    ...
    public List<Map<String, Object>> detectDisease(byte[] imageBytes) {
        ...
        for (int attempt = 1; attempt <= 3; attempt++) {
            try {
                ResponseEntity<Object> response = restTemplate.exchange(modelUrl, HttpMethod.POST, entity, Object.class);
