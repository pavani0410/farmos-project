                  ...
                  children: [
                        ...
                        Row(
                          children: [
                            ...
                            Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text('FarmOS · Dashboard',
                                  style: TextStyle(
                                    fontSize: 11,
                                    color: Colors.grey.shade500,
                                  ),
                                ),
                                const Text('Hi, Pavani',
                                  style: TextStyle(
                                    fontSize: 18,
                                    fontWeight: FontWeight.w700,
                              ...
                              children: [
                                ...
                                RichText(
                                  text: TextSpan(
                                    children: [
                                      TextSpan(
                                        text: '${totalAcres.toStringAsFixed(0)} ',
                                ...
                                Text('Across ${farms.length} active farm${farms.length != 1 ? 's' : ''}',
                                  style: TextStyle(
                                    fontSize: 11,
                                    color: Colors.white.withOpacity(0.6),
                                  ),
                          ...
                          child: Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                const SizedBox(height: 4),
                                Text('${farms.length} of ${farms.length} zones active',
                                  style: TextStyle(
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Text('See all',
                          style: TextStyle(
                            fontSize: 12, color: const Color(0xFF52B788),
                                        ...
                                        Expanded(
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              Text('${farm.acres} ac · ${farm.location}',
                                                style: TextStyle(
                                                  fontSize: 12,
                                                  color: Colors.grey.shade500,
                                                ),
...
class _PlotChip extends StatelessWidget {
  final String label;
  final Color color;
  const _PlotChip({required this.label, required this.color});
